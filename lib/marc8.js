...
var translate = function(marc8_string, options) {
    ...
    var buffer;
    if (typeof marc8_string === 'string' || marc8_string instanceof String) {
        buffer = new Buffer(marc8_string, 'binary');
    } else {
        buffer = marc8_string;
    }
    ...
    var buffer = new Buffer(marc8_string, 'binary');
    ...
    while (pos < buffer.length) {
        if (buffer[pos] === 0x1b) {
            ...
            } else if (G1_SET.indexOf(nextByte) >= 0) {
